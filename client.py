...
if __name__ == "__main__":
    ...
    for i in range(1000):
        ...
        resp = requests.get('http://172.17.0.2:5000/predict?source=https://raw.githubusercontent.com/ultralytics/ultralytics/main/ultralytics/assets/zidane.jpg', verify=False)
